...
|-------|-------------|------------|----------|
| Claude Code | `.claude/CLAUDE.md` | `.claude/memory/` | `docs/agents/claude.md` |
| Codex | `.codex/CODEX.md` | `.codex/memory/` | `docs/agents/codex.md` |

_Claude Chat (browser) is not a framework agent — it is a strategist used by Will; its outputs land in shared docs (`CONTEXT.md`, `DESIGN.md`, `IMPLEMENTATION.md`) via Will, not through this framework._
